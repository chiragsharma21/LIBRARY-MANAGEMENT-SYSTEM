				...
				<div class="books">
					<form action="" method="post" name="form1">
						<table class="table">
							<tr>
								<td>
									<input type="text" name="search" class="form-control" placeholder="Enter book name or author name">
								</td>
								<td>
                    ...
                    <?php
                        if (isset($_POST["submit1"])) {
                            $i=0;
                            $res = mysqli_query($link,"select * from add_book where books_name like('$_POST[search]%') OR books_author_name like('$_POST[search]%')");
                            ...
                            while ($row = mysqli_fetch_array($res)){
                               ...
                               ?> <a href="../../<?php echo $row["books_file"]; ?>" target="_blank"><img src="../../<?php echo $row["books_image"]; ?> " alt=""></a> <?php 
                                 ...
                                 echo "</br>";
                                 echo "<b>".$row["books_author_name"]; "</b>";
                                 echo "</br>";
                                 echo "<b>". 
