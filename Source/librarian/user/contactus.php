...
<body>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="right">
						...
						<div class="box">
							<p><i class="fas fa-home"></i><span>ghaziabad</span></p>
							<p><i class="far fa-envelope"></i><span> ashu200221@gmail.com</span></p>
							<p><i class="fas fa-phone"></i><span> 7004******</span></p>
							<p>(+91)982*******</p>
						</div>
					</div>
				</div>
    ...
    <div class="footer text-center">
        <p style="margin: 20px; font-weight: bold;"><span>copyright &copy;all rights reserved</span></p>
    </div>
